...
MODEL_FILE = os.getenv('MODEL_FILE', 'lin_red.bin')
MONGODB_ADDRESS = os.getenv('MONGODB_ADDRESS', 'mongodb://127.0.0.1:27017') # local host
...
def predict():
    ...
    record['PU_DO'] = '%s_%s' %(ride['PULocationID'], ride['DOLocationID'])
